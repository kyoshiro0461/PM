...
List<ClientsM> ClientsInfo = (ViewBag.ClientsInfo as List<ClientsM>);
    ...
    <div class="center js_tabbody">
        <form action="../../Clients/Clients_Edit?ID=<%=clientsinfo.CLID%>" method="post">
            <div class="wrap_mk wball">
                ...
                <div class="subwrap_mk_2">
                    ...
                    <div class="formbox w30">
                        <label>联系人</label>
                        <span><%=clientsinfo.CLPERSON %></span>
                    </div>
                    <div class="formbox w30">
                        <label>联系方式</label>
                        <span><%=clientsinfo.CLTEL%></span>
                    </div>
                    <div class="formbox w30">
                        <label>地址</label>
                        <span><%=clientsinfo.CLADDRESS %></span>
                    </div>
                    <div class="formbox w30">
                        <label>社会统一代码证号</label>
                        <span><%=clientsinfo.CLCODE %></span>
                    </div>
                    <div class="formbox w30">
                        <label>开户行</label>
                        <span><%=clientsinfo.CLBANK %></span>
                    </div>
                    <div class="formbox w30">
                        <label>账号</label>
                        <span><%=clientsinfo.CLACCOUNT %></span>
                    </div>
                    <%--<%if (paym == null)
                      {%>
                    <div>
            ...
            <div class="footerbtn">
                ...
                <a href="../../Clients/Clients?BELONG=<%=clientsinfo.CLBELONG %>" class="btn btn-gray">关闭</a>
            </div>
        </form>
        <div class="clear"></div>
    </div>

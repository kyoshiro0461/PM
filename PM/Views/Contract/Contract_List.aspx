...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="center js_tabbody">
        <form action="../../Contract/Contract_Edit?ID=<%=contractinfo.CTID%>" method="post">
            <div class="wrap_mk wball">
                ...
                <div class="subwrap_mk_2">
                    ...
                    <div class="formbox w30">
                        <label>合同名称</label>
                        <span><%=contractinfo.CTName %></span>
                    </div>

                    <div class="formbox w30">
                        <label>隶属</label>
                        <%if (contractinfo.CTBelong == "0")
                            {%>
                        <span>业主合同</span>
                        <%} %>
                        <%if (contractinfo.CTBelong == "1")
                            { %>
                        <span>施工队合同</span>
                        <%} %>
                        <%if (contractinfo.CTBelong == "2")
                            { %>
                        <span>供应商合同</span>
                        <%} %>
                    </div>
                    <div class="formbox w30">
                        ...
                        <span><% foreach (ProjectsM projectsm in ProjectsInfo) { %>
	    				     <%=(contractinfo.CTPrid==projectsm.PRID ?  projectsm.PRName:"") %>
                                <%} %></span>
                     </div>
                    <div class="formbox w30">
                        <label>往来客户名称</label>
                        <span><% foreach (ClientsM clientsm in ClientsInfo) { %>
	    				     <%=(contractinfo.CTClid==clientsm.CLID ?  clientsm.CLNAME:"") %>
                                <%} %></span>
                     </div>
                    <div class="formbox w30">
                        <label>合同金额</label>
                        <span><%=contractinfo.CTMoney %></span>
                    </div>
            ...
            <div class="footerbtn">
                ...
                <a href="../../Contract/Contract?BELONG=<%=contractinfo.CTBelong %>" class="btn btn-gray">关闭</a>
            </div>
        </form>
        <div class="clear"></div>
    </div>
